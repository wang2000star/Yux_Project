...
template <class P>
using TRLWE = std::array<Polynomial<P>, P::k + 1>;//k+1个多项式,每个多项式有n个系数
template <class P>
...
#define TFHEPP_EXPLICIT_INSTANTIATION_MY_CIRCUIT_BOOTSTRAPPING(fun) \
    fun(lvl10param, lvl02param, lvl21param);                     \
    fun(lvl10param, lvl02param, lvl22param);
#define TFHEPP_EXPLICIT_INSTANTIATION_SM4_CIRCUIT_BOOTSTRAPPING(fun) \
    fun(lvl10param, lvl02param, lvl21param);                     \
    fun(lvl10param, lvl02param, lvl22param);
