...
#include "../hybrid-HE-framework/ciphers/common_Zp/Cipher.h"

namespace PASTA2_3 {

//----------------------------------------------------------------
constexpr ZpCipherParams PASTA2_PARAMS = {256, 128, 128};
constexpr uint64_t PASTA2_T = PASTA2_PARAMS.plain_size;
constexpr uint64_t PASTA2_R = 3;
...
class PASTA2 : public ZpCipher {
 ...
 public:
  ...
  virtual std::string get_cipher_name() const { return "PASTA2 (n=128,r=3)"; }
