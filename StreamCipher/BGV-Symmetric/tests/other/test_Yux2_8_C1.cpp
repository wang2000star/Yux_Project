...
using namespace NTL;
using namespace C1ient_Yux2_8_C1;
using namespace Server_Yux2_8_C1;
int main()
{
    ...
    if (C1ient_Yux2_8_C1::Client_offline())
    {
        std::cout << "==========================================" << std::endl;
    ...
    if (Server_Yux2_8_C1::Server_offline())
    {
    ...
    std::cout << "==========================================" << std::endl;
    if (C1ient_Yux2_8_C1::Client_online())
    {
        std::cout << "==========================================" << std::endl;
    ...
    if (Server_Yux2_8_C1::Server_online())
    {
